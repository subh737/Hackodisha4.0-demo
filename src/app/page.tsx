...
import Hack from "./assets/HO3.png";
import ImageCenter from "./assets/centerLine.svg";
  ...
  return (
    ...
    <div className="bg-black w-full overflow-hidden relative  2xl:-mt-20 pt-20 hidden lg:block">
      ...
      <div className="mt-60 relative">
        <div className="">
          <div className="grid grid-cols-4">
            ...
            <Image src={Hack} className="w-310 h-113 mb-[48px] max-w-[20vw] lg:w-64" alt="Hack Odisha Logo" />
            </div>
          ...
          <div className="-m-16">
            <Image src={ImageCenter} alt="Line Image" />
          </div>
          ...
          <div className="flex flex-col gap-8 md:gap-20 col-span-2 ml-24 py-12 lg:text-2xl text-lg leading-loose">
              ...
              <ul className="inline-flex flex-col lg:--mt-2 xl:-mt-0 mt-6 text-start w-fit mx-auto gap-4 text-base md:text-xl font-syoog">
              ...
              <ul className="inline-flex flex-col text-start w-fit mx-auto lg:--mt-2 xl:-mt-0 mt-6 gap-4 text-lg md:text-2xl">
                ...
                <Image className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5 brightness-200  hover:brightness-75 transition-all ease-in"
                      src={discord} alt="Discord Logo" />
                      </a>
                </li>
                <li>
                <a className="text-center mb-5" href="https://www.instagram.com/webwiz.nitr/">
                <Image className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5 fill-[#8e8e8e] hover:brightness-75 transition-all ease-in"
                      src={insta} alt="Instagram Logo" />
                       </a>
                </li>
                <li>
                <a className="text-center mb-5" href="https://www.linkedin.com/company/hackodisha3/">
                <Image className="w-[2rem] h-[2rem] m-auto mb-5  hover:brightness-75 transition-all ease-in"
                      src={linkedin} alt="LinkedIn Logo" />
                       </a>
                </li>
                <li> <a className="text-center mb-5" href="https://x.com/webwiznitr">
                <Image className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5  hover:brightness-75 transition-all ease-in"
      ...
      <Image src={footerBuilding} className=" absolute object-contain object-bottom " alt="Building" />
        <div className=" my-4">
          <Image src={centerLineImage} className=" w-full" alt="Centre Line Image" />
        </div>
        <div>
          <div className=" w-fit mx-auto">
            ...
            <ul className=" inline-flex justify-between gap-8 ml-8 mt-6 text-lg sm:mx-2 lg:-ml-4 xl:-mt-12 md:text-2xl opacity-65">
              <li>
                ...
                <Image src={discord} className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5  brightness-200  hover:brightness-75 transition-all ease-in" alt="Disord Logo" />
                </a>
              </li>
              <li>
                <a href="https://www.instagram.com/webwiz.nitr/">
                <Image src={insta} className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5  brightness-200  hover:brightness-75 transition-all ease-in" alt="Instagram Logo" />
                </a>
              </li>
              <li>
                <a href="https://www.linkedin.com/company/hackodisha3/">
                <Image src={linkedin} className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5  brightness-200  hover:brightness-75 transition-all ease-in" alt="LinkedIn Logo" />
                </a>
              </li>
              <li>
                <a href="https://x.com/webwiznitr">
                <Image src={twitter} className="sm:w-[3rem] w-8 sm:h-[3rem] h-8 m-auto mb-5  brightness-200  hover:brightness-75 transition-all ease-in" alt="Twitter Logo" />
                </a>
              </li>
            </ul>
          </div>
          ...
          <div className=" text-white flex flex-col text-sm leading-loose gap-6 items-center  mx-auto w-fit font-syoog">
              ...
              <button className=" bg-[#CA40CD] font-syoog mb-4 rounded-[3.5rem] md:rounded-[3.5625rem] px-4 py-2   text-[#FFEAEA] text-[0.75rem] font-bold leading-[147%] hover:bg-fuchsia-400 ease-in duration-100 text-center w-fit">
                Become a sponsor
              </button>
              </a>
          </div>
